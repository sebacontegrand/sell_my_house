      ...
      >
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                <SelectTrigger id="whyneedtomove-select" className="w-[180px]">
        ...
        {whyNeedToMove === "otros" && (
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel htmlFor="otrosneedtomove-input" className="text-xl">
                  Specify Other Cause
                </FormLabel>
                <FormControl>
                  <Input
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-row gap-2 items-center w-full">
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                <SelectTrigger id="typeoperation-select" className="w-[180px]">
                  <SelectValue placeholder="Seleccione opción" />
                </SelectTrigger>
                <SelectContent>
                  <SelectGroup>
          ...
          render={({ field }) => (
            <FormItem className="flex flex-row gap-2 items-center w-full">
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  <SelectGroup>
                    <SelectItem value="losaradiante">Loza radiante</SelectItem>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-row gap-2 items-center w-full">
              <FormLabel className="text-xl">Categoría Edificación?</FormLabel>
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                <SelectTrigger className="w-[180px]">
        ...
        <div className="flex flex-row justify-center  m-2">
          <Button type="submit">Guardar Prelisting</Button>{" "}
